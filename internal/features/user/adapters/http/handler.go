...
// RegisterRoutes registers routes on the given router group.
...
// @Accept			json
// @Produce			json
// @Param			body	body		userapp.CreateUserInput	true	"Dados do usuário"
// @Success			201		{object}	userapp.UserView
...
func (h *Handler) Create(c *gin.Context) {
	in, ok := ginbind.JSON[userapp.CreateUserInput](c, "invalid json body")
	if !ok {
		return
	}
...
// @Produce			json
// @Security		BearerAuth
// @Success			200	{object}	userapp.UserView
