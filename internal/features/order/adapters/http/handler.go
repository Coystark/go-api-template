...
// Handler exposes HTTP endpoints for orders.
type Handler struct {
	svc *orderapp.Service
}

// NewHandler creates the order HTTP handler.
func NewHandler(svc *orderapp.Service) *Handler {
	return &Handler{svc: svc}
}

// RegisterRoutes registers order routes (authenticated).
...
// @Produce			json
// @Security		BearerAuth
// @Param			body	body		orderapp.CreateOrderInput	true	"Dados do pedido"
// @Success			201		{object}	orderapp.OrderView
...
func (h *Handler) Create(c *gin.Context) {
	in, ok := ginbind.JSON[orderapp.CreateOrderInput](c, "invalid json body")
	if !ok {
		return
	}
...
// @Success			200			{object}	orderapp.OrdersPage
// @Failure			400			{object}	httperr.ErrorResponse
// @Failure			401			{object}	httperr.ErrorResponse
// @Failure			500			{object}	httperr.ErrorResponse
// @Router			/orders [get]
func (h *Handler) List(c *gin.Context) {
	query, ok := ginbind.Query[orderapp.ListOrdersInput](c, "invalid list query")
	if !ok {
		return
	}
...
// @Success			200			{object}	orderapp.OrderServicesPage
// @Failure			400			{object}	httperr.ErrorResponse
// @Failure			401			{object}	httperr.ErrorResponse
// @Failure			500			{object}	httperr.ErrorResponse
// @Router			/order-services [get]
func (h *Handler) ListOrderServices(c *gin.Context) {
	query, ok := ginbind.Query[orderapp.ListOrderServicesInput](c, "invalid list order services query")
	if !ok {
		return
	}
...
// @Success			200	{object}	orderapp.OrderView
// @Failure			400	{object}	httperr.ErrorResponse
// @Failure			401	{object}	httperr.ErrorResponse
...
// @Security		BearerAuth
// @Param			id		path		string			true	"UUID v7 do pedido"
// @Param			body	body		orderapp.UpdateOrderInput	true	"Corpo do pedido"
// @Success			200		{object}	orderapp.OrderView
// @Failure			400		{object}	httperr.ErrorResponse
// @Failure			401		{object}	httperr.ErrorResponse
// @Failure			404		{object}	httperr.ErrorResponse
...
func (h *Handler) Update(c *gin.Context) {
	...
	in, ok := ginbind.JSON[orderapp.UpdateOrderInput](c, "invalid json body")
	if !ok {
		return
	}
